...
If we look at the adjusted R-squared value of the GRIP data, it is smaller than the ARM data's adjusted R-squared. In addition, the residual standard error is larger for the GRIP data than it is for the ARM data. Both of these values indicate that Model 1 is doing a better job at explaining our prediction and is a better model overall.
